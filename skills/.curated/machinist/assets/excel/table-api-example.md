...
/**
  * name: 碰撞层关系设定
  * sourcePath: map.map_/54/scripts/碰撞层关系设定.code
  */
@BeScript({ name: "碰撞层关系设定", color: [255, 222, 0] })
@events("clientStart")
...
/**
  * name: GM判断
  * sourcePath: map.map_/5/scripts/GM判断.code
  */
@BeScript({ name: "GM判断", color: [255, 255, 255] })
@events("clientStart")
